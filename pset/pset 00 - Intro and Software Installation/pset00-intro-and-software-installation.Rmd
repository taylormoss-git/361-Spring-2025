...
![](img/SurveyScreenshot-VishakSrikanth.png)
...
g = ggplot(iris, 
            aes(x = Petal.Width, 
                y = Petal.Length)) + 
  geom_point() + 
  ggtitle("Vishak Srikanth's animation")
g
...
![](img/snip of test animation-vishak.png)
...
![](img/bookmarks-VishakSrikanth.png)
...
![](img/snip of Github Desktop-VishakSrikanth.png)
...
Screenshot of Pull request created


![](img/PR-VishakSrikanth.png)
...
University affiliation verification has been competed and access to Student Developer Pack and GitHub coPilot is pending for my GitHub ID (mathaiml5).
See screenshot of Github Copilot below. The status is still in Approved (Green) state and not yet toggled to Purple (provisioned and activated state).


![](img/VishakGithubCoPilot.jpg)
