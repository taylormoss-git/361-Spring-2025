...
```
*** I KNOW THIS RETURNS NULL! It is because I use VS Code as my IDE, and therefore the rstudioapi package does not work here. I ran this in RStudio and it returned the correct version (pic attatched.)

![](img/jade_rstudioapi.png)
...
## save the animation
 #anim_save(a, 
       #   filename = '/Users/jadevillegas/Desktop/GitHub/361-Spring-2024/pset/pset 00 - Intro and Software Installation/img/test.gif')
