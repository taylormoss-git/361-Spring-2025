...
![](/Users/dylanoberst/Desktop/snip of Course Survey.png)
...
g = ggplot(iris, 
            aes(x = Petal.Width, 
                y = Petal.Length)) + 
  geom_point() + 
  ggtitle("Dylan Oberst's animation")
g
...
#save the animation
# anim_save(a, 
        #   filename = '/Users/dylanoberst/Desktop/spring24/361/test animation.gif')
...
![](/Users/dylanoberst/Desktop/snip of test animation.png)
...
![](/Users/dylanoberst/Desktop/snip of GitHub Desktop.png)
...
![](/Users/dylanoberst/Desktop/snip of GitHub Copilot.png)

I am unable to activate copilot in RStudio since my request is pending final approval. I have attached a screenshot of the message I received after uploading my academic credentials. 
