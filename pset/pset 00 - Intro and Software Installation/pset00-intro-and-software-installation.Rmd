...
![](img/snip of lisas animation.png)
...
I'm unable to activate copilot because I'm not affiliated with an organization yet on Github. I have submitted an application to Github to prove my academic status, so I think this issue should be resolved in the next few days.

See https://bmacgtpm.github.io/notes/github-copilot-in-rstudio.html.  

![](img/snip of lisas copilot.png)
