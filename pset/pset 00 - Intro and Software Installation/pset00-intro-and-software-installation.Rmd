...
![](../../../Desktop/Screenshot 2024-01-23 at 7.51.22 PM.png)
...
See https://bmacgtpm.github.io/notes/software-installation.html. The code from that page is below, except a custom title has been added. Replace my name with yours, _uncomment__ the animation code, run all of this code.
...
g = ggplot(iris, 
            aes(x = Petal.Width, 
                y = Petal.Length)) + 
  geom_point() + 
  ggtitle("Pranik Chainani's animation")
g
...
![](../../../Desktop/Screenshot 2024-01-23 at 7.56.08 PM.png)
...
Once you have created the animation, __comment__ out the code that creates the animation (as I have done above). This document won't knit to PDF with the animation code in it. You can only knit to HTML. 
...
![](../../../Desktop/Screenshot 2024-01-23 at 7.59.27 PM.png)
...
![](../../../Desktop/Screenshot 2024-01-23 at 8.07.16 PM.png)
