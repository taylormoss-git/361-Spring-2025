...
- Teaching Fellows, ULAs, and course manager, and office hours: see Canvas
- Midterms: TBD
...
**Submitting assignments.** You will submit assignments on Gradescope. On Gradescope there is a place to submit your PDF only, and a place to submit other files (usually just an .Rmd file, but sometimes we'll have other files, e.g. RMD, HTML, GIF). 
